...
<?php if ($activity) : ?>
    <fieldset style="background-color:aliceblue">
        ...
        <form action="controller.php" method="POST">
            <input type="hidden" name="request" value="Lasts">
            ...
            <table>
                ...
                <?php foreach ($activity["sequences"] as $i => $sequence) : ?>
                    <tr>
                        <th style="padding:20px 0" colspan="2"><?= $i + 1 ?>. <?= $sequence["last"]["question"] ?></th>
                    </tr>
                    <input type="hidden" name="target[]" value="<?= $sequence["last"]["position"] ?>">

...
<?php if ($activity && count($activity["definitions"]) > 3) : ?>
    <form>
        ...
        <input type="hidden" name="activity" value="Choose Definition from Word">
        ...
        <h1 style="margin-top:0;text-align:center">Choose Definition from Word</h1>
        ...
        <fieldset class="grey">
            ...
            <ol>
                ...
                <li>Select the definition that BEST describes it.</li>
            </ol>
            <div class="items">
                    ...
                    <div class="item">
                        <div class="question">
                            <div style="display:flex;flex-flow:row wrap;column-gap:10px">
                                <div class="word" id="<?= $definition["data"]["definition"] ?>"><?= $definition["data"]["word"] ?>
                                </div>
            ...
            <div class="buttons">
                ...
                <div style="margin-bottom:20px">
                    <!-- <a href="/scholar/stats/?page=best_by_activity&activity=Choose Definition From Word&guide_id=<?= $id ?>">See best results</a> -->
                    <a style="float:right" href="?page=Review&id=<?= $id ?>">Review</a>
                </div>

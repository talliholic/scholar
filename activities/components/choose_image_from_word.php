...
<?php if ($activity && count($activity["definitions"]) > 3) : ?>
    <form>
        ...
        <input type="hidden" name="activity" value="Choose Image from Word">
        ...
        <h1 style="margin-top:0;text-align:center">Choose Image from Word</h1>
        <fieldset class="grey best_results" id="best_results"></fieldset>
        <fieldset class="grey">
            <legend><?= $activity["title"] ?></legend>
            <ol>
                <h3>Instructions</h3>
                <li>Read the word out loud.</li>
                    ...
                    <div class="item">
                        <div class="question">
                            <div style="display:flex;flex-flow:row wrap;column-gap:10px">
                                <div class="word" id="<?= $definition["data"]["img_path"] ?>"><?= $definition["data"]["word"] ?> </div>
            ...
            <div class="buttons">
                ...
                <div style="margin-bottom:20px">
                    <!-- <a href="/scholar/stats/?page=best_by_activity&activity=Choose Image From Word&guide_id=<?= $id ?>">See best results</a> -->
                    <a style="float:right" href="?page=Choose Image from Definition&id=<?= $id ?>">Next Activity</a>
                </div>

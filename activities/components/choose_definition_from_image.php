...
<?php if ($activity && count($activity["definitions"]) > 3) : ?>
    <form>
        ...
        <input type="hidden" name="activity" value="Choose Definition from Image">
        ...
        <h1 style="margin-top:0;text-align:center">Choose Definition from Image</h1>
        ...
        <fieldset class="grey">
            ...
            <div class="items">
                <?php foreach ($activity["definitions"] as $i => $definition) : ?>
                    <div class="item">
                        <div class="question">
                            <img class="medium-img word" src="<?= $definition["data"]["img_path"] ?>" id="<?= $definition["data"]["definition"] ?>" alt="<?= $definition["data"]["word"] ?>">
                        ...
                        <div class="answers">
                            <?php foreach ($definition["options"] as $option) : ?>
                                <div class="option">
                                    ...
                                    <input class="input radio" type="radio" name="question_<?= $i ?>" value="<?= $option["definition"] ?>" required>
            ...
            <div class="buttons">
                ...
                <div style="margin-bottom:20px">
                    <!-- <a href="/scholar/stats/?page=best_by_activity&activity=Choose Definition From Image&guide_id=<?= $id ?>">See best results</a> -->
                    <a style="float:right" href="?page=Choose Definition from Word&id=<?= $id ?>">Next Activity</a>
                </div>

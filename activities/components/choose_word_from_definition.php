...
<?php if ($activity && count($activity["definitions"]) > 3) : ?>
    <form>
        ...
        <input type="hidden" name="activity" value="Choose Word from Definition">
        ...
        <h1 style="margin-top:0;text-align:center">Choose Word from Definition</h1>
        ...
        <fieldset class="grey">
                    ...
                    <div class="item">
                        <div class="question">
                            <div style="display:flex;flex-flow:row wrap;column-gap:10px">
                                <div class="word" id="<?= $definition["data"]["word"] ?>"><?= $definition["data"]["definition"] ?>
                                </div>
            ...
            <div class="buttons">
                ...
                <div style="margin-bottom:20px">
                    <!-- <a href="/scholar/stats/?page=best_by_activity&activity=Choose Word from Definition&guide_id=<?= $id ?>">See best results</a> -->
                    <a style="float:right" href="?page=Choose Definition from Image&id=<?= $id ?>">Next Activity</a>
                </div>

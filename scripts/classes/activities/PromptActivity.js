class PromptActivity {
    ...
    #get_multiple_answers(e) {
        ...
        document.querySelectorAll(".answer").forEach((input) => input.classList.add("hidden"))
    ...
    #get_feedback() {
        document.querySelectorAll(".feedback-div").forEach((div) => {
            div.classList.toggle("hidden")
            div.classList.add("row")
        })
        const feedbackDivs = document.querySelectorAll(".feedback")
        feedbackDivs.forEach((div, i) => div.textContent = 'You typed "' + this.#form[`question_${i}`].value +'"')
    ...
    #map_answers(e) {
        ...
        this.#answers.forEach((answer, i) => {
            ...
            if (input.toLowerCase() === answer.target.toLowerCase()) score = 1
            this.#answers[i] = {
                ...answer,
                input,
                score              
